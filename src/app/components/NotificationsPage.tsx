            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                    {(user?.role === "admin" || user?.role === "super_admin") && (
                        <Button variant="outline" onClick={generateAutoNotifications} className="bg-orange-100 text-orange-700">
                            Vérifier retards
                        </Button>
                    )}
                    <Button variant="outline" onClick={markAllAsRead} disabled={unreadCount === 0} className="bg-green-100 text-green-700">
                        Tout lire
                    </Button>
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-start justify-between gap-2">
                                                ...
                                                <span className="text-xs text-gray-400 whitespace-nowrap">{new Date(notif.created_at).toLocaleDateString("fr-FR")}</span>
                                            </div>
