...
const CONFIG = {
    success: {
        ...
        bg: "from-emerald-50 to-white dark:from-emerald-950/60 dark:to-slate-900",
    ...
    error: {
        ...
        bg: "from-rose-50 to-white dark:from-rose-950/60 dark:to-slate-900",
    ...
    warning: {
        ...
        bg: "from-amber-50 to-white dark:from-amber-950/60 dark:to-slate-900",
    ...
    info: {
        title: "Information",
        bg: "from-sky-50 to-white dark:from-sky-950/60 dark:to-slate-900",
