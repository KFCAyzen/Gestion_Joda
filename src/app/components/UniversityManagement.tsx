...
const predefinedUniversities: Omit<University, 'id' | 'created_at'>[] = [
    { nom: 'Université de Pekin (PKU)', pays: 'Chine', ville: 'Pékin', programme: 'Licence, Master, Doctorat', niveau_etude: 'Tous niveaux', criteres_admission: 'Bac + 12 min, HSK 4', active: true },
...
export default function UniversityManagement() {
    ...
    const resetForm = () => {
        setFormData({ nom: '', pays: '', ville: '', programme: '', niveau_etude: '', criteres_admission: '', active: true });
        setEditingUni(null);
        setActiveTab('list');
    };
                                        ...
                                        {universities.map(u => (
                                            <TableRow key={u.id}>
                                                <TableCell>
                                                    ...
                                                    <div className="text-sm text-gray-500">{u.pays}</div>
                                                </TableCell>
