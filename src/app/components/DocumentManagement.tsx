...
export default function DocumentManagement({ studentId, studentName }: DocumentManagementProps) {
    ...
    const getStatusColor = (status: string) => {
        switch (status) {
            case 'valide': return 'bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300';
            case 'non_conforme': return 'bg-red-100 text-red-800 dark:bg-red-900/40 dark:text-red-300';
            case 'en_attente': return 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/40 dark:text-yellow-300';
            default: return 'bg-gray-100 dark:bg-gray-700/50 text-gray-800 dark:text-gray-200';
        }
    };
    ...
    return (
        <div className="space-y-6">
                                        ...
                                        >
                                            {isUploading ? (
                                                ...
                                                <div className="flex flex-col items-center">
                                                    ...
                                                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">{t("uploadCta")}</p>
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{getDocumentLabel(docType.labelKey)}</p>
            ...
            {validationModal && (
                ...
                >
                    <div
                        className="max-w-md w-full rounded-xl bg-white dark:bg-slate-900 shadow-2xl"
                    >
                        ...
                        <div className="p-6">
                            ...
                            {validationModal.status === 'non_conforme' && (
                                <div className="space-y-2">
                                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300">{t("modal.reasonLabel")}</label>
                                    <Input
