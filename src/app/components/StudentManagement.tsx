    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8">
            ...
            <div className="mb-4 flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 flex-1 max-w-full sm:max-w-full sm:max-w-lg md:max-w-xl md:max-w-2xl">
                    <input
                        type="text"
            ...
            {showForm && (
                <div className="bg-gray-50 border rounded p-4 sm:p-6 mb-4" style={{borderColor: '#dc2626'}}>
                    ...
                    <div className="mb-4 sm:mb-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-3 sm:p-4">
                            <input 
                    ...
                    <div className="mb-4 sm:mb-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:p-4">
                            ...
                            {filteredStudents.map((student) => (
                                <div key={student.id} className="bg-gradient-to-br from-white to-slate-50 p-4 sm:p-5 rounded-xl border border-slate-200 hover:shadow-md transition-all duration-200 hover:border-slate-300 group">
                                    <div className="flex items-start justify-between mb-3">
                                        <div className="w-6 h-6 sm:w-8 sm:h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center" style={{backgroundColor: '#f3f4f6'}}>
