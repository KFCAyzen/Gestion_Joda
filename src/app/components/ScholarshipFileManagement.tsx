        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="hidden lg:flex gap-6">
            ...
            <div className="text-center">
              ...
              <div className="text-xs sm:text-sm text-gray-500">Approuvés</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-600">{files.filter(f => f.status === 'review').length}</div>
              <div className="text-xs sm:text-sm text-gray-500">En révision</div>
            </div>
          </div>
        </div>

        {/* Filtres et recherche */}
        <div className="flex flex-col sm:flex-row gap-3 sm:p-4">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-red-500 to-red-700 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg overflow-hidden">
                        {file.photoUrl ? (
                      ...
                      <div>
                        ...
                        <p className="text-xs sm:text-sm text-gray-500">{file.program}</p>
                      </div>
                    </div>
                    <span className={`px-2 sm:px-4 py-1 sm:py-2 rounded-full text-xs font-bold shadow-sm ${getStatusColor(file.status)}`}>
              ...
              <div className="space-y-3 sm:space-y-2 sm:space-y-3 md:space-y-4 md:space-y-6">
                ...
                <div className="glass-card p-8">
                  <div className="text-center mb-8">
                    ...
                    <span className={`inline-block px-2 sm:px-4 py-1 sm:py-2 rounded-full text-xs sm:text-sm font-bold mt-2 ${getStatusColor(selectedFile.status)}`}>
                ...
                {/* Documents détaillés */}
                <div className="glass-card p-8">
                  <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-8 flex items-center gap-2">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    Documents Requis
                ...
                <div className="glass-card p-8">
                  ...
                  <div className="mt-3 flex justify-end">
                    <Button className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-sm font-medium">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
