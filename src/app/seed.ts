    ...
    const notifications = [
      {
        ...
        message: "Votre paiement Ouverture de dossier est en retard.",
        read: false,
        created_at: new Date().toISOString()
      },
      {
    ...
    const entrees = [
      {
        ...
        description: 'Ouverture de dossier - Jean Dupont',
        student_id: student1Id,
        created_by: agentId,
        created_at: new Date().toISOString()
      },
      {
        ...
        type: 'paiement_procedure',
        description: 'Caution - Jean Dupont',
        student_id: student1Id,
        created_by: agentId,
        created_at: new Date().toISOString()
      },
      {
        ...
        type: 'paiement_procedure',
        description: 'Ouverture de dossier - Marie Mbou',
        student_id: student2Id,
        created_by: agentId,
        created_at: new Date().toISOString()
      }
