            ...
            <div className={`${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 fixed lg:static inset-y-0 left-0 z-50 w-64 transition-transform duration-300 ease-in-out flex flex-col glass-sidebar`}>
                ...
                <nav className="flex-1 px-3 py-4 overflow-y-auto">
                    <div className="space-y-4">
                        ...
                        <div>
                            <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 px-2">Comptabilité</h3>
                            <div className="space-y-1">
                                <button
                                    onClick={() => {setCurrentPage("comptabilite"); setIsMobileMenuOpen(false);}}
                                    className={`w-full flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors ${
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900">
                                    {currentPage === "home" ? "Dashboard" :
                                     ...
                                     currentPage === "comptabilite" ? "Comptabilité" :
