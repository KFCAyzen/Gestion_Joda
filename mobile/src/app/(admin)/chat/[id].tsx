...
const styles = StyleSheet.create({
  ...
  input: { flex: 1, height: 46, paddingHorizontal: 16, borderRadius: radius.pill, borderWidth: 1, borderColor: colors.glassLine, backgroundColor: colors.glass, color: '#fff', fontSize: 14 },
