...
const makeStyles = (colors: Palette) => {
  ...
  return StyleSheet.create({
    ...
    backBtn: { width: 38, height: 38, borderRadius: 12, borderWidth: 1, borderColor: colors.glassLine, backgroundColor: colors.glass2, alignItems: 'center', justifyContent: 'center' },
    body: { paddingVertical: 8, gap: 8 },
    bub: { maxWidth: '82%', paddingHorizontal: 14, paddingVertical: 9, borderRadius: 18 },
    bubIn: { alignSelf: 'flex-start', backgroundColor: colors.glass2, borderWidth: light ? 1 : 0, borderColor: colors.glassLine, borderTopLeftRadius: 6 },
    bubOut: { alignSelf: 'flex-end', backgroundColor: light ? colors.crimsonDeep : 'rgba(209,26,42,0.30)', borderTopRightRadius: 6 },
    ...
    input: { flex: 1, height: 46, paddingHorizontal: 16, borderRadius: radius.pill, borderWidth: 1, borderColor: colors.glassLine, backgroundColor: colors.glass, color: colors.text, fontSize: 14 },
    sendBtn: { width: 46, height: 46, borderRadius: 23, backgroundColor: colors.crimsonDeep, alignItems: 'center', justifyContent: 'center' },
  });
};
